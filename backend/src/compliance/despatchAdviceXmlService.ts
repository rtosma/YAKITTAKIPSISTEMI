...
// TEST-1006: GTIP eşlemesi saf bir modüle (./gtip.ts) taşındı — birim testler libxmljs2 (native) yüklemeden koşsun. Davranış aynı; geriye dönük
// uyumluluk için burada yeniden dışa aktarılır (test_comp601 buradan import eder).
export { resolveGtip };
